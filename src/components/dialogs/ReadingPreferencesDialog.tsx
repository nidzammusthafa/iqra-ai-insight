        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value) => updateTemp('translationFontSize', value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="compact">{lineSpacingLabels.compact}</SelectItem>
                <SelectItem value="normal">{lineSpacingLabels.normal}</SelectItem>
                <SelectItem value="relaxed">{lineSpacingLabels.relaxed}</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value) => updateTemp('defaultTranslation', value as TranslationId)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value={TranslationId.ID}>{translationLabels[TranslationId.ID]}</SelectItem>
                <SelectItem value={TranslationId.EN}>{translationLabels[TranslationId.EN]}</SelectItem>
                <SelectItem value={TranslationId.AR}>{translationLabels[TranslationId.AR]}</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateTemp('showTranslation', checked)}
            />
          </div>
          ...
          <div className="border rounded-lg p-4 space-y-3">
            ...
            <div 
              className={`arabic-text ${
                tempPreferences.arabicFontSize === 'small' ? 'arabic-small' :
                tempPreferences.arabicFontSize === 'large' ? 'arabic-large' :
                tempPreferences.arabicFontSize === 'xl' ? 'text-3xl' : ''
              } ${
                tempPreferences.lineSpacing === 'compact' ? 'leading-tight' :
                tempPreferences.lineSpacing === 'relaxed' ? 'leading-loose' : 'leading-normal'
              }`}
            >
            ...
            {tempPreferences.showTranslation && (
              <div className={`text-muted-foreground ${
                tempPreferences.translationFontSize === 'small' ? 'text-sm' :
                tempPreferences.translationFontSize === 'large' ? 'text-lg' : 'text-base'
              } ${
                tempPreferences.lineSpacing === 'compact' ? 'leading-tight' :
                tempPreferences.lineSpacing === 'relaxed' ? 'leading-loose' : 'leading-normal'
              }`}>
